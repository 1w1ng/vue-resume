	...
	<div id="editor">
		...
		<ol class="panes">
			...
			<li v-bind:class="{active: currentTab === 2}">
				<ArrayEditor v-bind:items="resume.educationBg" v-bind:labels="{school:'学校',duration:'时间',degree:'学位'}" title="教育背景"/>
			</li>
			<li v-bind:class="{active: currentTab === 3}">
				<ArrayEditor v-bind:items="resume.skills" v-bind:labels="{name:'技能特长',content:'技能描述'}" title="技能清单"/>
			</li>
			<li v-bind:class="{active: currentTab === 4}">
				<ArrayEditor v-bind:items="resume.projects" v-bind:labels="{name:'项目名称',content:'项目描述'}" title="项目经验"/>
			</li>
